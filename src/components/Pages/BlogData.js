...
export const blogPosts = [
  ...
  },
  {
    ...
    excerpt:
      'Aqeedah — Islamic creed — is the bedrock of every Muslim\'s faith. This article explores how students can learn it clearly, confidently, and with lasting impact.',
    tags: ['islamic-studies', 'faith', 'education'],
  },
  {
    id: 7,
    ...
    category: 'Islamic Studies',
    comments: 1,
    title: 'Fiqh basics every Muslim student should know',
    excerpt:
      'From purification and prayer to transactions and ethics, foundational Fiqh knowledge equips students to live Islam consciously every day.',
  ...
  },
  {
    ...
    category: 'Islamic Studies',
    comments: 2,
    title: 'Prophetic manners and how to teach them online',
    excerpt:
  ...
  },
  {
    ...
    category: 'STEM',
    comments: 0,
    title: 'Environmental stewardship: what Islam teaches about the natural world',
    excerpt:
      'Islam calls every believer to be a responsible steward of the Earth. Discover how environmental science connects with Islamic values of gratitude, balance, and care.',
  ...
  },
  {
    ...
    category: 'Character',
    comments: 1,
    title: 'Honesty in learning: why Sidq is the Muslim student\'s greatest asset',
    excerpt:
      'Truthfulness (Sidq) transforms how students study, reflect, and grow. When honesty is the foundation of learning, every achievement becomes meaningful.',
  ...
  },
  {
    ...
    category: 'Character',
    comments: 0,
    title: 'Patience and consistency: the Islamic approach to deep learning',
    excerpt:
      'Sabr (patience) and consistency are the most underrated qualities in a student\'s journey. Explore Prophetic guidance on perseverance and how it shapes meaningful education.',
...
export const blogCategories = [
  {
    ...
    description:
      'Practical Islamic knowledge for modern life, including Aqeedah, Fiqh basics, Seerah lessons, and Prophetic manners for students and families.',
  },
  {
    name: 'Quranic Arabic',
    slug: 'quranic-arabic',
    description:
      'Step-by-step Arabic pathways that help learners understand Quranic vocabulary, grammar patterns, and meanings directly from the text.',
  },
  {
    name: 'Recitation',
    slug: 'recitation',
    description:
      'Structured Tajweed and recitation practice focused on correct pronunciation, rhythm, confidence, and reverence when reciting the Quran.',
  },
  {
    name: 'STEM',
    slug: 'stem',
    description:
      'Faith-centered STEM learning where scientific curiosity is encouraged alongside Islamic values, ethics, and purposeful innovation.',
  },
  {
    name: 'Character',
    slug: 'character',
    description:
      'Character-building content inspired by Quran and Sunnah to develop discipline, honesty, empathy, resilience, and leadership.',
  },
];

export const blogTags = [
  { name: 'Quran',         slug: 'quran',          description: 'Articles focused on Quran learning, reflection, and recitation quality.' },
  { name: 'Arabic',        slug: 'arabic',          description: 'Foundational and intermediate Arabic learning insights.' },
  { name: 'Tajweed',       slug: 'tajweed',         description: 'Tips and guidance on articulation and recitation rules.' },
  { name: 'Seerah',        slug: 'seerah',          description: 'Lessons from the life of Prophet Muhammad (peace be upon him).' },
  { name: 'STEM',          slug: 'stem',            description: 'Integrated STEM topics connected with Islamic worldview.' },
  { name: 'Character',     slug: 'character',       description: 'Personal development through Islamic values.' },
  { name: 'Education',     slug: 'education',       description: 'Effective online Islamic education methods.' },
  { name: 'Faith',         slug: 'faith',           description: 'Content that strengthens iman through knowledge and worship.' },
  { name: 'Islamic Studies', slug: 'islamic-studies', description: 'Core Islamic knowledge and creed.' },
];

export const categoryFromSlug = (slug) => blogCategories.find((item) => item.slug === slug) || null;
export const tagFromSlug      = (slug) => blogTags.find((item) => item.slug === slug) || null;
